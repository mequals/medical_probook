<script>
   <?php
         if ($this->session->flashdata('customer_success')) 
         {
            echo "var data = ' ".$this->session->flashdata('customer_success')."';";
            echo "success(data);";
         }
   ?>
</script>
   ...
   <div class="content">
      <header class="page-header">
         <div class="d-flex align-items-center">
            <div class="mr-auto">
               <h1 class="separator">Customer Groups  </h1>
                     ...
                     <div style="float: right;"><?php $sectionpermission=$this->session->userdata('section_permission');
                              if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="15" && $section_list['acc_add']=="1"){
                                      ?>
                     ...
                     <table id="bs4-table" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                           <tr>
                              ...
                              if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="15" &&($section_list['acc_view']=="1" || $section_list['acc_edit']=="1" || $section_list['acc_delete']=="1")){?>
                        ...
                        <tbody>
                           <?php
                              if (!empty($customer_group)) {
                                  $s = 1;
                                  foreach ($customer_group as $list) {
                                      ?>
                           <tr>
                              ...
                              if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="15" && $section_list['acc_edit']=="1"){
                                      ?>                                
                                 <a href="#" onclick="edit_customer('<?php echo ucfirst($list['id']); ?>','<?php echo ucfirst($list['customer_group_name']); ?>','<?php echo ucfirst($list['status']); ?>','<?php echo ucfirst($list['description']); ?>')" id="usertypeedit" class="btn btn-info btn-sm editusertype"><i class="zmdi zmdi-edit zmdi-hc-fw" data-toggle="modal" data-target="#editusertype"  style="
                                    font-size: 17px;
                                    color:  white;
                                    "></i></a> <?php } } } if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="15" && $section_list['acc_delete']=="1"){?>  
                              ...
                              <td class="s_no"><?php echo ucfirst($list['customer_group_name']); ?></td>
               ...
               <div class="col">
                  <div class="card">
                     ...
                     <?php
                        ...
                        echo form_open('master/customer/customer_group_add', $attributes);
                        ?> 
                     <div class="card-body">
                        <div class="form-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label class="col-form-label-lg control-label" for="largeInput">Customer group Name <span style="color:red">*</span></label>
                                    <div class="input-group mb-3">
                                       <div class="input-group-prepend">
                                          <span class="input-group-text " id="basic-icon-addon1"><i class="zmdi zmdi-accounts zmdi-hc-fw"></i></span>
                                       </div>
                                    <input type="text" class="form-control" name="customergroup[customer_group_name]" id="inputName" placeholder="customer group Name" required>
                              ...
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <select class="form-control" name="customergroup[status]" id="defaultSelect" required="">
                              ...
                              <div class="col-md-12">
                                       ...
                                       <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Enter Description" name="customergroup[description]" rows="3"></textarea>
                                    </div>
                                                </div>
                           </div>
                        </div>
...
<div class="modal modal-right-side fade" id="editusertype" data-backdrop="static" tabindex="-1" role="dialog"  aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content" >
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel6">Customer Group</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" class="zmdi zmdi-close"></span>
            </button>
         </div>
         <div class="modal-body">
            <div class="row">
               <div class="col">
                  <div class="card">
                     <h5 class="card-header">Edit Customer Group</h5>
                     <?php
                        $attributes = array('id' => 'login_form','data-toggle' => 'validator');
                        echo form_open('master/customer/customer_group_edit', $attributes);
                        ?>
                     <div class="card-body">
                        <div class="form-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <input type="hidden" class="customer_id" name="customer_group_id" >
                                    <input type="text" class="form-control customer_name" name="customergroup[customer_group_name]" id="inputName" placeholder="Customer Group Name" required >
                                 </div>
                                 </div>
                              </div>
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label class="col-form-label-lg" for="largeInput">Status</label>
                                    <select class="form-control status" name="customergroup[status]" id="defaultSelect" required="">
                                       <option value="1">Active</option>
                                       <option value="2">In-Active</option>
                                    </select>
                                 </div>
                              ...
                              <div class="col-md-12">
                                                   <div class="form-group">
                                       <label for="exampleFormControlTextarea1">Description</label>
                                       <textarea class="form-control description"  placeholder="Enter Description" id="exampleFormControlTextarea1" name="customergroup[description]" rows="3"></textarea>
                                    </div>
                             </div>
                           </div>
                        </div>
