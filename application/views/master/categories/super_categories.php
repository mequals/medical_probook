<script>
   <?php
         if ($this->session->flashdata('super_category_success')) 
         {
            echo "var data = ' ".$this->session->flashdata('super_category_success')."';";
            echo "success(data);";
         }
   ?>
</script>
   ...
   <div class="content">
      <header class="page-header">
         <div class="d-flex align-items-center">
            <div class="mr-auto">
               <h1 class="separator">Material Types</h1>
               <nav class="breadcrumb-wrapper" aria-label="breadcrumb">
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active" aria-current="page">Material Types</li>
                  </ol>
               </nav>
            </div>
                     ...
                     <div style="float: right;"><?php $sectionpermission=$this->session->userdata('section_permission');
                              if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="10" && $section_list['acc_add']=="1"){
                                      ?> 
                     ...
                     <table id="bs4-table" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                           <tr>
                              ...
                              if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="10" &&($section_list['acc_view']=="1" || $section_list['acc_edit']=="1" || $section_list['acc_delete']=="1")){?>
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="10" && $section_list['acc_edit']=="1"){
                                      ?>                                  
                                 <a href="#" onclick="edit_country('<?php echo ucfirst($list['id']); ?>','<?php echo ucfirst($list['super_cat_name']); ?>','<?php echo ucfirst($list['status']); ?>')" id="usertypeedit" class="btn btn-info btn-sm editusertype"><i class="zmdi zmdi-edit zmdi-hc-fw" data-toggle="modal" data-target="#editusertype"  style="
                                    font-size: 17px;
                                    color:  white;
                                    "></i></a><?php } } } if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="10" && $section_list['acc_delete']=="1"){?>  
                              ...
                              <td class="s_no"><?php echo ucfirst($list['super_cat_name']); ?></td>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel6">Material Type</h5>
         ...
         <div class="modal-body">
            <div class="row">
               <div class="col">
                  <div class="card">
                     <h5 class="card-header">Add Material Type</h5>
                     <?php
                        $attributes = array('id' => 'login_form','data-toggle' => 'validator');
                        echo form_open('master/categories/super_add', $attributes);
                        ?> 
                     <div class="card-body">
                        <div class="form-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label class="col-form-label-lg control-label" for="largeInput">Material Type Name <span style="color:red">*</span></label>
                                    <div class="input-group mb-3">
                                               <div class="input-group-prepend">
                                                  <span class="input-group-text " id="basic-icon-addon1"><i class="zmdi zmdi-case zmdi-hc-fw"></i></span>
                                               </div>
                                    <input type="text" class="form-control" name="category[super_cat_name]" id="inputName" placeholder="Material Type Name" required>
                                 </div>
                                 </div>
                              </div>
                              <div class="col-md-12">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row">
               <div class="col">
                  <div class="card">
                     <h5 class="card-header">Edit Material Type </h5>
                     <?php
                        $attributes = array('id' => 'login_form','data-toggle' => 'validator');
                        echo form_open('master/categories/super_edit', $attributes);
                        ?>
                     <div class="card-body">
                        <div class="form-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control super_cat_name" name="category_edit[super_cat_name]" id="inputName" placeholder="Material Type Name" required >
