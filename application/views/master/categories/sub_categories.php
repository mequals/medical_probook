<script>
   <?php
         if ($this->session->flashdata('sub_category_success')) 
         {
            echo "var data = ' ".$this->session->flashdata('sub_category_success')."';";
            echo "success(data);";
         }
   ?>
</script>
   ...
   <div class="content">
      <header class="page-header">
         <div class="d-flex align-items-center">
            <div class="mr-auto">
               <h1 class="separator">Sub Categories</h1>
                     ...
                     <div style="float: right;"><?php $sectionpermission=$this->session->userdata('section_permission');
                              if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="12" && $section_list['acc_add']=="1"){
                                      ?>
                     ...
                     <table id="bs4-table" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                           <tr>
                              ...
                              if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="12" &&($section_list['acc_view']=="1" || $section_list['acc_edit']=="1" || $section_list['acc_delete']=="1")){?>
                              <th class="text-center" width="15%">Action</th><?php } } }?>
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="12" && $section_list['acc_edit']=="1"){
                                      ?>                                 
                                 <a href="#" onclick="edit_Category('<?php echo ucfirst($list['id']); ?>','<?php echo ucfirst($list['sub_cat_name']); ?>','<?php echo ucfirst($list['status']); ?>')" id="usertypeedit" class="btn btn-info btn-sm editusertype"><i class="zmdi zmdi-edit zmdi-hc-fw" data-toggle="modal" data-target="#editusertype"  style="width: 17px;
                                   
                                    color:  white;
                                    "></i></a><?php } } } if (!empty($sectionpermission)) {
                                  foreach ($sectionpermission as $section_list) {
                                    if($section_list['section_id']=="12" && $section_list['acc_delete']=="1"){?>  
                                 <a href="" onclick="delete_coutry('<?php echo ucfirst($list['id']); ?>','<?php echo ucfirst($table_name); ?>')" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deletemodel"><i class="zmdi zmdi-delete zmdi-hc-fw" style="width: 17px;
                                    
                                    color:  white;
                                    "></i></a><?php } } } ?>                                      
                              </td><?php } } } ?>
                              <td class="s_no"><?php echo ucfirst($list['sub_cat_name']); ?></td>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel6">Sub Categories</h5>
               ...
               <div class="col">
                  <div class="card">
                     ...
                     <?php
                        ...
                        echo form_open('master/categories/sub_add', $attributes);
                        ?> 
                     <div class="card-body">
                        <div class="form-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label class="col-form-label-lg control-label" for="largeInput">Sub Category Name <span style="color:red">*</span></label>
                                    <div class="input-group mb-3">
                                               <div class="input-group-prepend">
                                                  <span class="input-group-text " id="basic-icon-addon1"><i class="zmdi zmdi-format-subject zmdi-hc-fw"></i></span>
                                               </div>
                                    <input type="text" class="form-control" name="category[sub_cat_name]" id="inputName" placeholder="Sub Category Name" required>
            ...
            <div class="row">
               <div class="col">
                  <div class="card">
                     ...
                     <?php
                        $attributes = array('id' => 'login_form','data-toggle' => 'validator');
                        echo form_open('master/categories/sub_edit', $attributes);
                        ?>
                     <div class="card-body">
                        <div class="form-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control sub_cat_name" name="category_edit[sub_cat_name]" id="inputName" placeholder="Sub Category Name" required >
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-12">
      ...
      <div class="modal-content">
         ...
         <form action="<?php echo base_url();?>master/categories/delete" method="POST">
            <div class="modal-body">
               ...
               <!-- Hiiden Values -->
               <input type="text" name="url" value="<?php echo $this->router->method; ?>">
