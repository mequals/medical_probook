                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control tax_name"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $prefix_setting[0]['user_prefix']; ?>" name="common_prefix[user_prefix]" required="">
                                    </div>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control ccommon_prefix"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $prefix_setting[0]['customer_prefix']; ?>" name="common_prefix[customer_prefix]" required="">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label class="col-form-label-lg control-label" for="largeInput">Employee Prefix</label>
                                     <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control scommon_prefix"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $prefix_setting[0]['employee_prefix']; ?>" name="common_prefix[employee_prefix]" required="">
                                    </div>              
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control tax_name"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $prefix_setting[0]['item_prefix']; ?>" name="common_prefix[item_prefix]" required="">
                                    </div>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control ccommon_prefix"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $prefix_setting[0]['vendor_prefix']; ?>" name="common_prefix[vendor_prefix]" required="">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label class="col-form-label-lg control-label" for="largeInput">Branch Prefix</label>
                                     <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control scommon_prefix"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $prefix_setting[0]['branch_prefix']; ?>" name="common_prefix[branch_prefix]" required="">
                                    </div>              
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control tax_name"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $transaction_prefix[0]['purchase_invoice']; ?>"  name="transaction_prefix[purchase_invoice]" required="">
                                    </div>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control ccommon_prefix"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $transaction_prefix[0]['sale_bill']; ?>"  name="transaction_prefix[sale_bill]" required="">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label class="col-form-label-lg control-label" for="largeInput">Purchase Order Prefix</label>
                                     <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control scommon_prefix"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $transaction_prefix[0]['purchase_order']; ?>"  name="transaction_prefix[purchase_order]" required="">
                                    </div>              
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control tax_name"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $transaction_prefix[0]['sale_order']; ?>"  name="transaction_prefix[sale_order]" required="">
                                    </div>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control ccommon_prefix"  aria-label="Icon Left" aria-describedby="basic-icon-addon1"  value="<?php  echo $transaction_prefix[0]['purchase_return']; ?>"  name="transaction_prefix[purchase_return]" required="">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label class="col-form-label-lg control-label" for="largeInput">Sales Return Prefix</label>
                                     <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control scommon_prefix"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $transaction_prefix[0]['sale_return']; ?>"  name="transaction_prefix[sale_return]" required="">
                                    </div>              
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label class="col-form-label-lg control-label" for="largeInput">DC/MEMO Prefix</label>
                                     <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control scommon_prefix"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $transaction_prefix[0]['dc_memo']; ?>"  name="transaction_prefix[dc_memo]" required="">
                                    </div>              
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label class="col-form-label-lg control-label" for="largeInput">Expense Prefix</label>
                                     <div class="input-group mb-3">
                                       ...
                                       <input type="text" class="form-control scommon_prefix"  aria-label="Icon Left" aria-describedby="basic-icon-addon1" value="<?php  echo $transaction_prefix[0]['expense']; ?>"  name="transaction_prefix[expense]" required="">
                                    </div>              
                                 </div>
                              </div>
                           </div>
